...
export function AiScriptStep({
  ...
  const {
    ...
    labels: {
      ...
      agentName: s.chatAgentName,
      stageSkeleton: s.stageSkeleton,
      stageAdaptation: s.stageAdaptation,
      stageSkeletonComplete: s.stageSkeletonComplete,
      stageAdaptationComplete: s.stageAdaptationComplete,
      stageScriptsComplete: s.stageScriptsComplete,
      stageScriptsProgress: s.stageScriptsProgress,
      pipelineComplete: s.chatPipelineComplete,
      pipelineStopped: s.chatPipelineStopped,
      pipelineErrorTitle: s.chatPipelineErrorTitle,
      pipelineErrorSkeletonBody: s.chatPipelineErrorSkeletonBody,
      pipelineErrorAdaptationBody: s.chatPipelineErrorAdaptationBody,
      pipelineErrorScriptsBody: s.chatPipelineErrorScriptsBody,
      pipelineErrorGenericBody: s.chatPipelineErrorGenericBody,
      pipelineErrorTips: s.chatPipelineErrorTips,
      pipelineErrorDetailPrefix: s.chatPipelineErrorDetailPrefix,
