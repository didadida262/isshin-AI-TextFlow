...
import type { ImageGenerationSettings } from "../../services/config";
import {
  IMAGE_TEST_PROMPT,
  testImageConnection,
                ...
                <div className="space-y-4">
                  {generating ? (
                    <div
                      ...
                      aria-busy="true"
                    >
                      <PaintbrushLoading label={generateLabels.generating} />
                    </div>
                  ) : null}
